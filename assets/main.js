...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.icons.style1', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, stagger: 125, replay: false });
